...
from app.grpc_gen import agent_pb2 as agent__pb2
...
class AgentServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.Connect = channel.stream_stream(
                '/yimai.agent.v1.AgentService/Connect',
...
def add_AgentServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'yimai.agent.v1.AgentService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('yimai.agent.v1.AgentService', rpc_method_handlers)
